        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('terorist.store')}}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required="" name="warga_negara">
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="informasi_lain" id="" cols="30" rows="10" class="form-control"></textarea>
                            </div>
                        </div>
