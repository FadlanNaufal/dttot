    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route('terorist.index')}}" class="btn btn-warning">Kembali</a>
                    <br><br>
                    @if ($errors->any())
                    ...
                    @endif
                    <form method="POST" action="{{route('terorist.update',$data->id)}}">
                        @csrf @method('patch')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required="" name="warga_negara" value="{{$data->warga_negara}}">
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="informasi_lain" id="" cols="30" rows="10" class="form-control">
                                {{$data->informasi_lain}}
                                </textarea>
                            </div>
                        </div>
